...
#ifndef __NV32_BIT_BAND_H__
#define __NV32_BIT_BAND_H__
#ifdef __cplusplus
extern "C" {
#endif
...
__STATIC_INLINE void BIT_BandVariableInit( uint32_t * pVariableAddress, BIT_BandPtr * pBitbandPtr )
{
  ...
  ASSERT( ( ( uint32_t )pVariableAddress >= 0x20000000 ) && ( ( uint32_t )pVariableAddress <= 0x200002FF ) );
